...
```json
{
  "mcpServers": {
    "ServiceNow": {
      "command": "/Users/gibfn/code/learning/servicenow-mcp/.venv/bin/python",
      "args": [
        "-m",
        "servicenow_mcp.cli"
      ],
      "env": {
        "SERVICENOW_INSTANCE_URL": "https://bayersawt.service-now.com",
        "SERVICENOW_USERNAME": "MUEMC",
        "SERVICENOW_PASSWORD": "4r_0VabGmg(9",
